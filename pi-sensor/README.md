...
4.2  sudo java -Dserver.uri=https://droidrace.caglabs.se/race/passageDetected -Djavax.net.ssl.trustStore=keystore.jks -jar pi-sensor-0.0.1-SNAPSHOT-jar-with-dependencies.jar

Hämta hem Cert och skapa keystore
---------------------------------
1. Kör följande och plocka PEM-filen: openssl s_client -host droidrace.caglabs.se -port 443
